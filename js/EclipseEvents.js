 ...
 */
    ...
    function initMap() {
        ...
        layerControl = new L.control.layers(null, null, {position: 'bottomright', collapsed:false, autoZIndex:true});
        layerControl.addTo(map);
    }

    function initBaseLayer() {
        // Layer für die Copyright-Infos:
        var baseLayer = L.tileLayer('http://api.tiles.mapbox.com/v3/ralphmueller.i1lhfh9m/{z}/{x}/{y}.png',
            {
                maxZoom : 18,
