...
function processData(data) {
    ...
    $("#eventsmail1").append(
        "<p class=\"text-right\">Missing your event on this site? Please submit your event to the <a href=\"https://github.com/EclipseFdn/events.eclipse.org/issues/new?template=event.md\">Eclipse Newsroom</a>.<br> You may also send email to <a href=\"mailto:events@eclipse.org\">events@eclipse.org</a>, but the Eclipse Newsroom is the better option.</p>");
    $("#eventsmail2").append(
       "<p class=\"text-right\">Missing your event on this site? Please submit your event to the <a href=\"https://github.com/EclipseFdn/events.eclipse.org/issues/new?template=event.md\">Eclipse Newsroom</a>.<br> You may also send email to <a href=\"mailto:events@eclipse.org\">events@eclipse.org</a>, but the Eclipse Newsroom is the better option.</p>");
